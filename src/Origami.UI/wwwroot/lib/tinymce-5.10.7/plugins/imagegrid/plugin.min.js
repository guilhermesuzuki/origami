...
tinymce.PluginManager.add('imagegrid', function (editor, url) {
    ...
    var img = '<img loading="lazy" src="/lib/tinymce-5.10.7/plugins/imagegrid/select-image.png" style="width:100%;height:100%;" alt="select image" />';
